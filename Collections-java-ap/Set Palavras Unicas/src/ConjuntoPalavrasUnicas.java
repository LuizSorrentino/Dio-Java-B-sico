...
public class ConjuntoPalavrasUnicas {
    ...
    public static void main(String[] args) {
        ...
        palavrasUnicas.verificarPalavra("jose");
    ...
    public void verificarPalavra(String palavra){
        for (String p : palavrasUnicas) {
            if (p==palavra) {
                System.out.println("A palavra " + palavra +" encontra-se presente na lista.");
                break;
            }else{
                System.out.println("A palavra " + palavra +" NÃO encontra-se presente na lista.");
                break;
            }
        }
    }
